...
public class TerritoryAdjacencyComponent {
    public HashMap<Integer, Integer[]> Borders = new HashMap<>();
    public HashMap<Integer, Integer[]> Continent = new HashMap<>();
    public HashMap<Integer, Territory> TerritoryObjects = new HashMap<>();
    public HashMap<Integer, Continent> ContinentObjects = new HashMap<>();
